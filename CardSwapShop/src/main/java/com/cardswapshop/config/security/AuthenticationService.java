package com.cardswapshop.config.security;

import com.cardswapshop.config.security.JwtService;
...
import com.cardswapshop.model.Role;
...
public class AuthenticationService {
    ...
    //Método para registrar al user, guardarlo en DB y generar el jwt token
    ...
    //Método para login del user y generar el jwt token
